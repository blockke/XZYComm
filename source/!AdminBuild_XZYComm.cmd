...
rem
rem     RAD Studio RX12   (Delphi RX12)     VCLVersion=29	Path="Studio\23.0"
...
if %VCLVersion% == 29 set ProgPath=Embarcadero\Studio\23.0
...
if %VCLVersion% == 29 goto Version29
...
set IDE_Name=RAD Studio RX12
set PkgSuffix=290

set LibDir32=RX12\Win32
set LibDir64=RX12\Win64
set Compile64bit=True
set UnitScopeNames=-NSSystem;System.Win;Winapi;Vcl;Vcl.Imaging;Data;
